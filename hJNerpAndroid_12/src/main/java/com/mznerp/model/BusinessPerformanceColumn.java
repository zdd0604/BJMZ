...
public class BusinessPerformanceColumn {
    private String flag_sts;
    private String id_flow;
    private String date_audit;
    private String date_eva;
    private String date_plan;
    private Double dec_cmark;
    private Double dec_dmark;
    private Double dec_emark;
    private Double dec_smark;
    private Double dec_import;
    private Double dec_stdmark;
    private Double dec_mark;
    private Double dec_scale;
    ...
    public Double getDec_cmark() {
        return dec_cmark;
    }

    public void setDec_cmark(Double dec_cmark) {
        this.dec_cmark = dec_cmark;
    }

    public Double getDec_dmark() {
        return dec_dmark;
    }

    public void setDec_dmark(Double dec_dmark) {
        this.dec_dmark = dec_dmark;
    }

    public Double getDec_emark() {
        return dec_emark;
    }

    public void setDec_emark(Double dec_emark) {
        this.dec_emark = dec_emark;
    }

    public Double getDec_smark() {
        return dec_smark;
    }

    public void setDec_smark(Double dec_smark) {
        this.dec_smark = dec_smark;
    }

    public Double getDec_import() {
        return dec_import;
    }

    public void setDec_import(Double dec_import) {
        this.dec_import = dec_import;
    }

    public Double getDec_stdmark() {
        return dec_stdmark;
    }

    public void setDec_stdmark(Double dec_stdmark) {
        this.dec_stdmark = dec_stdmark;
    }

    public Double getDec_mark() {
        return dec_mark;
    }

    public void setDec_mark(Double dec_mark) {
        this.dec_mark = dec_mark;
    }

    public Double getDec_scale() {
        return dec_scale;
    }

    public void setDec_scale(Double dec_scale) {
    ...
    public int getOri_line_no() {
        return ori_line_no;
    }

    public void setOri_line_no(int ori_line_no) {
    ...
    public String toString() {
        return "BusinessPerformanceColumn{" +
                "flag_sts='" + flag_sts + '\'' +
                ", id_flow='" + id_flow + '\'' +
