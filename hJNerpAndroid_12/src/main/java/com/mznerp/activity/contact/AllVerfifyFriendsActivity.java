package com.mznerp.activity.contact;
...
import com.mznerp.activity.contact.adapter.AllVerfifyFriendsListAdapter;
...
import com.mznerp.model.VerfifyFriendInfo;
...
public class AllVerfifyFriendsActivity extends ActionBarWidgetActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (friendsInfoList == null) {
            ...
            for (int i = 0; i < friendsInfoList.size(); i++) {
                LogShow(" ***** name is " + friendsInfoList.get(i).getFriendname());
            }
        }
        ...
        listview.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                ...
                LogShow("click position is " + arg2 + " temp friend id is " + vfriendInfo.getFriendid());
