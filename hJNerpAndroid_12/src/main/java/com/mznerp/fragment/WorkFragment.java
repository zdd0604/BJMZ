...
import com.mznerp.activity.work.ApprovalActivity;
import com.mznerp.activity.work.WorkListBillTypeWindow;
import com.mznerp.adapter.WorkflowListAdapter;
import com.mznerp.common.Constant;
import com.mznerp.common.EapApplication;
import com.mznerp.common.FragmentSupport;
import com.mznerp.dao.OtherBaseDao;
import com.mznerp.model.IDComConfig;
import com.mznerp.model.WorkflowBillTypeData;
import com.mznerp.model.WorkflowBillTypeInfo;
import com.mznerp.model.WorkflowBillTypeResp;
import com.mznerp.model.WorkflowListInfo;
import com.mznerp.model.WorkflowListResp;
...
public class WorkFragment extends FragmentSupport {
    ...
    private int j = 0;
    private int num;
    private String[] buss_types;//注册获取能使用的类型
...
//                    listview.onRefreshComplete();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (idconfig != null) {
            if (idconfig.getVar_worktable().contains(",")) {
                buss_types = idconfig.getVar_worktable().split(",");
                for (int i = 0; i < buss_types.length; i++) {
                    Log.i("buss_type", buss_types[i]);
                    bu_types.add(buss_types[i]);
                }
            } else {
                bu_types.add(idconfig.getVar_worktable());
            }
...
//                    ToastUtil.ShowShort(context, "未获得该单据的使用权，请与软件供应商联系");
                }
                ...
                try {
                    ...
                    if ("result".equalsIgnoreCase(workflowResp.type)
                        ...
                        // {
                        {
                            ...
                            if (isAllType || bu_types.contains(info.getBillType())) {//不再判断是否可操作全部
//                            if (bu_types.contains(info.getBillType())) {
